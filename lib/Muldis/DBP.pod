...
Muldis::DBP -
Formal spec of an abstract database protocol for Perl 6

=head1 VERSION

This document is Muldis::DBP version 0.1.0.-9 for Perl 6.
...
the B<Muldis DBP> (B<MDBP>) library API for Perl 6.

The fully-qualified name of this document and the library API specification
it contains is C<Muldis_DBP_Perl6 'http://muldis.com' '0.1.0.-9'>.  It is
...
The Muldis DBP specification for Perl 6 is expressly designed
...
Iff Perl 6 libraries that implement the MDBP choose to explicitly support
...
These existing or prospective Perl 6 libraries implement at least 1 version
of the B<Muldis DBP> API: L<Muldis::D::Ref_Eng>, and so on.
