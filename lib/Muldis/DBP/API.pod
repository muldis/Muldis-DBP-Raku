...
Perl 6 has a direct C<Reference> analogy which is provided by the Perl 6
...
Perl 6 has a direct C<Excuse> analogy which is provided by the Perl 6
class C<Failure>.
...
Perl 6 has a direct C<Excuse_No_Such_Index> analogy which is provided by
