...
This document is Muldis::DBI::Duck_Coupling::API version 0.1.0.-9 for Perl 6.
...
concrete Perl 6 library named C<Muldis::DBI::Duck_Coupling::API>; however,
...
The B<Muldis Duck Coupling DBI> (B<MDCDBI>) library API for Perl 6 formally
...
foundation for Perl 6 code that is able to speak the B<Muldis Duck Coupling
DBI> API.  If this turns out not to be the case, the minimum required Perl
